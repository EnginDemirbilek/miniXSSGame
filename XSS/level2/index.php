...
<p><strong><font color="red" size:2>LEVEL 2</font></strong></p>
...
<button onclick="location='/XSS/level3/'">Next Level</button><br>
...
if(preg_match("/script/img/body/svg/iframe",$data))
{
echo "<br>";
